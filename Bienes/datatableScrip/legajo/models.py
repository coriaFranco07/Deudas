...
class Legajo(models.Model):
    id_legajo=models.PositiveBigIntegerField(unique=True)
    nro_doc=models.PositiveBigIntegerField(null=True)
    ...
    def __str__(self) -> str:
       return f" {self.nro_doc} [{self.nombres} {self.jerarquia} {self.cuerpo}] "
