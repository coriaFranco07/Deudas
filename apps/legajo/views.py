...
class ListLegajo(LoginRequiredMixin, PermissionRequiredMixin,SuccessMessageMixin,ListView): 
        model=Legajo
        template_name='legajos.html'
        context_object_name='legajos' 
        permission_required = "legajo.view_legajo"
...
class AddLegajo(LoginRequiredMixin, PermissionRequiredMixin,SuccessMessageMixin,CreateView):
     model=Legajo
     template_name='add_legajo.html'
     form_class=LegajoForm
     success_url=reverse_lazy('list_legajos')
     permission_required = "legajo.add_legajo"
...
class EditLegajo(LoginRequiredMixin, PermissionRequiredMixin,SuccessMessageMixin,UpdateView):        
     model=Legajo
     template_name='edit_legajo.html'
     form_class=LegajoForm
     success_url=reverse_lazy('list_legajos')
     success_message='Registro editado correctamente'
     permission_required = "legajo.change_legajo"
...
class DeleteLegajo(LoginRequiredMixin, PermissionRequiredMixin,SuccessMessageMixin,DeleteView):
     model=Legajo
     template_name='del_legajo.html'  #o crear marca_confirm_delete.html y esta linea se omite
     permission_required = "legajo.delete_legajo"
     success_url=reverse_lazy('list_legajos')
